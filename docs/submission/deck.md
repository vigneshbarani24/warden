...
## Production notes
- The deck is already built as `deck.html` (open it, present full-screen). If you rebuild in Canva/Slides, export the diagram pages from `docs/warden-diagrams.drawio` to PNG (diagrams.net → Export → PNG) for slide 7.
